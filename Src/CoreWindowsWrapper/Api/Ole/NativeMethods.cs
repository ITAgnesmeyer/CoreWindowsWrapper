...
namespace CoreWindowsWrapper.Api.Ole
{
    ...
    internal static class NativeMethods
    {
        ...
        ///riid: IID*
        ///ppv: LPVOID*
        [DllImportAttribute("ole32.dll", EntryPoint="CoCreateInstance", CallingConvention=CallingConvention.StdCall)]
        ...
        ///lpiid: LPIID->IID*
        [DllImportAttribute("ole32.dll", EntryPoint="IIDFromString", CallingConvention=CallingConvention.StdCall)]
        ...
        ///rclsid: IID*
        ///lplpsz: LPOLESTR*
        [DllImportAttribute("ole32.dll", EntryPoint="StringFromIID", CallingConvention=CallingConvention.StdCall)]
        public static extern  int StringFromIID(ref Guid rclsid, ref IntPtr lplpsz) ;


        /// Return Type: HRESULT->LONG->int
        ///pvReserved: LPVOID->void*
        [DllImportAttribute("ole32.dll", EntryPoint="CoInitialize", CallingConvention=CallingConvention.StdCall)]
        ...
        public static extern  IntPtr LoadLibrary([InAttribute] [MarshalAsAttribute(UnmanagedType.LPWStr)] string lpLibFileName) ;
